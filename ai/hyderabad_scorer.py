...
{{
  "score": 85,
  "fit_reason": "They are building a modern web product with React and Node, which matches your core skills perfectly.",
  "stack_overlap": ["React", "Node.js"],
  "urgency_signal": "Active GitHub commits and small team size of 3 people.",
  "disqualify_reason": null,
  "pass": true,
  "suggested_contact_approach": "direct email"
}}
...
Return JSON object:
{{
  "subject": "React developer available — noticed you are building company_name",
